...
<?php
	if(isset($_POST['submit']))
	{
		...
		$query = "insert into enrolls values ('{$webmail_id}','{$course_id}',{$semester}, {$abs_year} )";
  ...
  <div class="container">
    ...
    <section id="content">
      ...
      <div class="inside">
		...
		<form action="admin_reg_student.php" method="post">
			<table>
				<tr>
					<td>Student Webmail Id: </td>
					...
					?></td>
					<td>(Select from the available Students)</td>
				</tr>
				<tr>
					<td>Course Id: </td>
        ...
        <?php
			...
			{
				if(isset($_POST['submit']))
				echo "<p> Successfully registered Student !</p>";
